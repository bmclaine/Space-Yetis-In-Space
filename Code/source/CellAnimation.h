...
public:
	...
	void	InitializeLaserExplosion(void);
	void	InitializeShipExplosion(void);
	void	InitializeAIShipExplosion(void);
	void	InitializeBossShipExplosion(void);
	void	InitializeMoonExplosion(void);
	void	InitializeMoon(void);
