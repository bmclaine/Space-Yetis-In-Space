...
void CellAnimation::InitializeLaserExplosion(void)
{
	// Load the image
	m_hImage = SGD::GraphicsManager::GetInstance()->LoadTexture(
		L"resource/graphics/BM_LaserExplosion.png", { 255, 255, 255, 255 });
...
void CellAnimation::InitializeShipExplosion(void)
{
	// Load the image
	m_hImage = SGD::GraphicsManager::GetInstance()->LoadTexture(
		L"resource/graphics/BM_ShipExplosion.png", { 255, 255, 255, 255 });
...
void CellAnimation::InitializeAIShipExplosion(void)
{
	// Load the image
	m_hImage = SGD::GraphicsManager::GetInstance()->LoadTexture(
		L"resource/graphics/BM_AIShipExplosion.png", { 255, 255, 255, 255 });
...
void CellAnimation::InitializeBossShipExplosion(void)
{
	// Load the image
	m_hImage = SGD::GraphicsManager::GetInstance()->LoadTexture(
		L"resource/graphics/BM_BossShipExplosion.png", { 255, 255, 255, 255 });
...
void CellAnimation::InitializeMoonExplosion(void)
{
	// Load the image
	m_hImage = SGD::GraphicsManager::GetInstance()->LoadTexture(
		L"resource/graphics/BM_ShipExplosion.png", { 255, 255, 255, 255 });
...
void CellAnimation::InitializeMoon(void)
{
	// Load the image
	m_hImage = SGD::GraphicsManager::GetInstance()->LoadTexture(
		L"resource/graphics/BM_Moon.png", { 255, 255, 255, 255 });
